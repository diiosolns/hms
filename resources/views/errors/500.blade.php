            ...
            <div class="container">
                <div class="nk-block">
                    <div class="nk-block-content wide-sm text-center mx-auto">
                        ...
                        <h2 class="nk-error-title mb-2">Oops! something went wrong on our servers.</h2>
                        <p class="nk-error-text">We are very sorry for inconvenience. Please try again later. </p>
