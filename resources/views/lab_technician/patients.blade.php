                    ...
                    <div class="nk-block-head">
                                    <div class="nk-block-head-between flex-wrap gap g-2">
                                        <div class="nk-block-head-content">
                                            <h2 class="nk-block-title">Patients History Tests</h2>
                                                <nav>
                                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                                        ...
                                                        @endif
                                                        <li class="breadcrumb-item active" aria-current="page">History Test Requests</li>
                                                    </ol>
                                                </nav>
                                        </div>
                                        <div class="nk-block-head-content">
                                        ...
                                        <div class="card-body flex-grow-0 py-2">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h4 class="title">Lab Tests History</h4>
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-middle mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="5" class="text-center text-muted">No completed patient tests found.</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
