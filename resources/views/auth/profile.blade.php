                                            ...
                                            <div class="card-content col-sep">
                                                <div class="card-body">
                                                    <div class="bio-block">
                                                        ...
                                                        <p>Hey, I'm <b>{{ $user->first_name }} {{ $user->last_name }}</b>, <br> I am a <b>{{ ucwords($user->role) }}</b> at <i>{{ $user->branch->name ?? 'N/A' }}</i> hospital branch, under the <i>{{ $user->hospital->name ?? 'N/A' }}</i> Hospital.</p>
