                                    ...
                                    <div class="nk-block-head-between flex-wrap gap g-2">
                                            ...
                                            <h2 class="nk-block-title">Pharmacy Items</h2>
                                                <nav>
                                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="{{ route('admin.pharmacy.create') }}">Add new Item</a></li>
                                                        @endif
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="d-flex">
                                                ...
                                                @elseif(Auth::user()->role === 'pharmacist')
                                                    <li>
                                                        <a href="{{ route('pharmacist.items.create') }}" class="btn btn-md d-md-none btn-primary" >
                                                            <em class="icon ni ni-plus"></em>
                                                            <span>Add</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('pharmacist.items.create') }}" class="btn btn-primary d-none d-md-inline-flex" >
                                                            <em class="icon ni ni-plus"></em>
                                                            <span>Add Pharmacy Item</span>
                                                        </a>
                                                    </li>
