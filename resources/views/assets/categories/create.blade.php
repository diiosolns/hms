            ...
            <div class="nk-content-body">
                <div class="nk-block-head">
                    <div class="nk-block-head-between flex-wrap gap g-2 align-items-center">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title">Add Asset Category</h2>
                            <nav>
                ...
                <div class="nk-block">
                    <div class="card card-gutter-md">
                        <div class="card-body">
                            <h4 class="mb-4">Register New Category</h4>
                            ...
                            <form action="{{ route('assets.categories.store') }}" method="POST">
                                ...
                                <div class="row g-3">
                                    ...
                                    <!-- Submit -->
                                    <div class="col-lg-12">
                                        <button class="btn btn-primary" type="submit">Save Asset Category</button>
                                    </div>
                                </div>
                            </form>
