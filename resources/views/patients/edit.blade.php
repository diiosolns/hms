                            ...
                            <div class="nk-content-body">
                                    ...
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-between flex-wrap gap g-2 align-items-center">
                                            <div class="nk-block-head-content">
                                                <h2 class="nk-block-title">Patient Update Form</h2>
                                                    <nav>
                                ...
                                <div class="nk-block">
                                    <div class="card card-gutter-md">
                                        <div class="card-body">
                                            <div class="bio-block">
                                                <h4 class="bio-block-title mb-4">Update Patient Details</h4>
                                                        ...
                                                        <div class="row g-3">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select class="form-control @error('pay_method') is-invalid @enderror" 
                                                                            ...
                                                                            <option value="Cash" {{ old('pay_method', $patient->pay_method) == 'Cash' ? 'selected' : '' }}>Cash</option>
                                                                            <option value="Insurance" {{ old('pay_method', $patient->pay_method) == 'Insurance' ? 'selected' : '' }}>Insurance</option>
                                                                        </select>
                                                                        @error('pay_method')
                                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                                        @enderror
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select class="js-select @error('service_id') is-invalid @enderror" 
                                                                                name="service_id" 
                                                                                id="service_id" 
                                                                                data-search="true" 
                                                                                data-sort="false">
                                                            ...
                                                            <div class="col-lg-12 g-4">
                                                                <div class="form-check form-switch form-check-lg g-2">
                                                                    <input class="form-check-input" type="checkbox" name="avoid_nurse" value="yes" id="flexSwitchDefault"
                                                                           {{ old('avoid_nurse', $patient->avoid_nurse) == 'yes' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="flexSwitchDefault">
                                                                        Avoid Nurse
                                                                        <small style="color: red;"> (Turn on this switch to send Patient details to Doctor direct. Nurse will be bypassed)</small>
                                                                    </label>
                                                                </div>
                                                            </div>
