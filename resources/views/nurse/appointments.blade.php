                    ...
                    <div class="card">
                        <table class="datatable-init table" data-nk-container="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="tb-col">{{ $appointment->patient->first_name ?? 'N/A' }} {{ $appointment->patient->last_name ?? '' }}</td>
                                    <td class="tb-col">{{ $appointment->doctor->first_name ?? 'N/A' }} {{ $appointment->doctor->last_name ?? '' }}</td>
                                    <td class="tb-col">
